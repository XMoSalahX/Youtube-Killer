...
if (window.sessionStorage.getItem("Go To Ver") === "Go") {
    ...
    if (verificated === false) {
        ...
        if (ver.length <= 5) {
            if (ver[ver.length - 1] === "") {
                ...
                fullName.value.split("").forEach(function(e) {
                    if (e === " ") {
                        alertName.innerHTML = "The confirmation code is wrong and we have deleted it because it contains spaces"
                        alertName.style.color = "red"
                        fullName.value = ""
                        boolver = false
                    } else {
...
if (window.sessionStorage.getItem("Go To Ver")) {
